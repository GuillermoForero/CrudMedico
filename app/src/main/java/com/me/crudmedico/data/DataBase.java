...
public class DataBase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table appointment(codeDoctor varchar(100),idPatient varchar(100),newMedical date, attended boolean, FOREIGN KEY (codeDoctor) REFERENCES doctor(code), FOREIGN KEY (idPatient) REFERENCES patient(id))");
    }
